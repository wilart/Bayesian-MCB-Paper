#This function estimates the power given parameters about a SMART study of design type I.
...
ComputePowerBayesianDesign1 <- function(sample_size=100,
  ...
  # rejection_indices: indices of which embedded dynamic treatment regimes to exclude in power calculation.
...
for (i in 1:1000) {
  ...
  #Stage-2 randomization indicator given stage-2 treatment was 0
  ...
  #embedded DTR response probabilities using Robin's G-computation method
  ...
  ranks_quantile <- ceiling(quantile(rank_max,1-0.05))
